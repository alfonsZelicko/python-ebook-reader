...
import pytest
import logging
from server.schema import ErrorCode, ErrorFormatter, ErrorLogger
...
class TestErrorFormatter:
    ...
    def test_format_engine_not_allowed_error(self):
        ...
        assert error["extensions"]["details"]["allowed"] == ["OFFLINE", "ONLINE", "G_CLOUD"]
    ...
    def test_format_service_error(self):
        ...
        error = ErrorFormatter.format_service_error(
            "TTS processing failed with api_key=secret123",
