...
def setup_logger(config) -> logging.Logger:
    ...
    console_formatter = ColoredFormatter(config.log_format, datefmt="%Y-%m-%d %H:%M:%S")
...
class RequestLogger:
    ...
    def log_request(self, operation_name: str, variables: dict) -> None:
        ...
        self.logger.info(
            ...
            extra={"operation": operation_name, "variables": sanitized_vars},
        )
    ...
    def log_service_start(self, service_type: str, input_file: str) -> None:
        ...
        Args:
            ...
            input_file: Path to input_data file being processed
        """
        self.logger.info(
            f"{service_type} operation started",
            extra={"service": service_type, "input_file": input_file},
        )

    def log_service_complete(
        self, service_type: str, execution_time: float, output_file: str
    ) -> None:
        """
    ...
    def log_error(
        self, error_message: str, context: dict, exc_info: bool = True
    ) -> None:
        """
        ...
        """
        self.logger.error(error_message, extra=context, exc_info=exc_info)
