...
Validates: Requirements 3.1, 3.2, 4.1, 4.2, 7.1, 7.9
"""

import strawberry
from typing import Union, TYPE_CHECKING

from server.types.outputs import TTSResult, TranslationResult, JobStatus, JobStatusEnum, JobProgress

if TYPE_CHECKING:
    from server.context import Context
    from server.types.inputs import TTSInput, TranslationInput
...
class Mutation:
    ...
    async def generate_speech(
        ...
        Validates: Requirements 3.1, 3.2, 7.1, 7.9
        """
            ...
            if async_mode:
                ...
                job_id = await job_manager.create_job(
                    ...
                    service_func=lambda inp, progress_callback: 
                        ...
                        self._run_async_service(tts_service.generate_speech, inp, progress_callback),
                    input_data=input
                )
    ...
    async def translate_text(
        ...
        Validates: Requirements 4.1, 4.2, 7.1, 7.9
        """
        context: Context = info.context
        logger = context.logger
            ...
            if async_mode:
                ...
                job_id = await job_manager.create_job(
                    ...
                    service_func=lambda inp, progress_callback: 
                        # Note: We need to handle async/sync conversion here
                        # The service function is async but executor expects sync
                        self._run_async_service(translation_service.translate_text, inp, progress_callback),
                    input_data=input
                )
    ...
    def _run_async_service(self, service_func, input_data, progress_callback):
        ...
        return loop.run_until_complete(
            service_func(input_data, progress_callback)
        )
