...
def test_all_tts_fields_mapped():
    ...
    expected_fields = [
        'text_content', 'file_upload',  # Added by generator
        'engine', 'chunk_size', 'chunk_by_paragraph', 'speaking_rate',
        'output_type', 'max_file_duration', 'clean_output_directory',
        'offline_voice', 'language_code', 'google_credentials', 'google_voice',
        'coqui_model', 'coqui_speaker', 'coqui_wav', 'coqui_sample_rate'
    ]
...
def test_all_translation_fields_mapped():
    ...
    expected_fields = [
        'text_content', 'file_upload',  # Added by generator
        'engine', 'source_language', 'target_language', 'translation_prompt',
        'chunk_size', 'chunk_by_paragraph', 'openai_api_key', 'openai_model',
        'google_credentials', 'gemini_model', 'deepl_api_key',
        'max_retries', 'retry_delay', 'clean_output_directory'
    ]
